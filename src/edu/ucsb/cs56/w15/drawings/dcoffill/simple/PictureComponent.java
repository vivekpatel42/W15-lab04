package edu.ucsb.cs56.w15.drawings.dcoffill.simple;
...
/**
   ...
   @author David Coffill (fixed the snowmans's head)
...
public class PictureComponent extends JComponent
{
   ...
   public void paintComponent(Graphics g)
   {
      ...
      Circle snowManTopCircle =
       ...
       g2.drawString("Top of snowman added by David Coffill", 20,40);
    }

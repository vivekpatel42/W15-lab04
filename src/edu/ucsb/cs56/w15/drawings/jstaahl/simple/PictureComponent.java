package edu.ucsb.cs56.w15.drawings.jstaahl.simple;
...
/**
   ...
   @author Jakob Staahl (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      g2.draw( house);
       ...
       g2.drawString("Top of snowman added by Jakob Staahl", 20,40);
    }

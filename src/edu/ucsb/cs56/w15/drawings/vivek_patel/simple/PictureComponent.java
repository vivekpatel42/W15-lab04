package edu.ucsb.cs56.w15.drawings.vivek_patel.simple;
...
/**
   ...
   @author Vivek Patel (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Vivek Patel", 20,40);
    }
